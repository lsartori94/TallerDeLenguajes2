/**
 * Es una pelota que rebota infinitamente en el espacio dado.
 * @author lsartori
 *
 */
...
/**
 * Borra la pantalla y dibuja un nuevo circulo
 * @param posicionX posicion en el eje X del circulo
 * @param posicionY	posicion en el eje Y del circulo
 * @param radius	radio del circulo
 */
	private static void dibujaCirculo(double posicionX, double posicionY,
			double radius) {
